                  ...
                  <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                          <h4 class="card-title">Records Information</h4>
                      ...
                      <div class="card-body">
                        <div id="reports" class="mb-3">
                          <a href="/imports/view/<?= $_GET['id']?>/generate-egace-report" class="btn btn-default btn-sm"><i class="fa-regular fa-file-lines"></i>  EGACE Summary Report</a>
